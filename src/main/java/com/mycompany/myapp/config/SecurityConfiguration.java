...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        .and()
            ...
            .antMatchers("/api/books/addtoCart").permitAll()
            // .antMatchers("/api/books/subfromCart").hasAuthority(AuthoritiesConstants.USER)
            .antMatchers("/api/books/tacgia/").permitAll()
            .antMatchers("/api/books/tag/").permitAll()
            .antMatchers("/api/books/**").permitAll()
