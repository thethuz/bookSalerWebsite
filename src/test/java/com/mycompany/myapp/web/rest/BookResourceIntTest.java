...
public class BookResourceIntTest {
    ...
    private static final Integer DEFAULT_GIA_CU = 1;
    private static final Integer UPDATED_GIA_CU = 2;

    private static final Integer DEFAULT_GIA_MOI = 1;
    private static final Integer UPDATED_GIA_MOI = 2;

    private static final String DEFAULT_TAC_GIA = "AAAAAAAAAA";
    private static final String UPDATED_TAC_GIA = "BBBBBBBBBB";

    private static final Integer DEFAULT_NAM_XUAT_BAN = 0;
    private static final Integer UPDATED_NAM_XUAT_BAN = 1;
    ...
    public void getAllBooks() throws Exception {
        ...
        restBookMockMvc.perform(get("/api/books?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].giaCu").value(hasItem(DEFAULT_GIA_CU)))
